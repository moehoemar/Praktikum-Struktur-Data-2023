...
public:
    ...
    void tambahCabang(CabangSewa cabang) {
        cabangSewa[cabangSewaCount++] = cabang;
...
int main() {
    ...
    CabangSewa cabangA = { "Jakarta Rent", "Jakarta", new int[3] {10, 5, 8} };
    manajemenSewa.tambahCabang(cabangA);

    CabangSewa cabangB = { "Surabaya Mobil", "Surabaya", new int[3] {15, 7, 10} };
    manajemenSewa.tambahCabang(cabangB);

    CabangSewa cabangC = { "Mobilan Bandung", "Bandung", new int[3] {8, 3, 6} };
    manajemenSewa.tambahCabang(cabangC);
